...
change_contact = ['Введите новое имя или ENTER, чтобы оаставить без изменений: ',
                  'Введите новый номер телефона или ENTER, чтобы оаставить без изменений: ',
                  'Введите новый комментарий или ENTER, чтобы оаставить без изменений: ']
